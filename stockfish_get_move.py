...
# params for stockfish                              here is path
fen = "8/2b1kp2/p1p3p1/Pp1p1nPp/1P1PpP1P/2P1P2R/2K5/6R1 w -- 0 1"; depth = 20; top_moves = 5; engine_path = "stockfish16.exe"
...
def print_position(board, engine):
    ...
    # stockfish.get_evaluation()["value"]/100
